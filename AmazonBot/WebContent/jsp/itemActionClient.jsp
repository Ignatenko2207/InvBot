	...
	<div class="content">
		<div class="table">
			<ul class="nav-tabs">
				...
				if(session.getValue("action").equals("edit")){
				%>
					<li><a class="active"  href="">Edit item</a></li>
				<%
				} else{
				%>
				...
				<div class="table-content">
					<table>
						<div class="content" id="main-box">
							...
							//create new item servlet
							if(session.getValue("action").equals("create")){
							%>
							<div class="table-header">
								<form action="/AmazonBot/servlets/ItemActionServlet">
									<input type="text" required name="link-item" id="input-link" placeholder="Paste link to fast creation of item" size="124">
									<input type="hidden" name="action" value="checkLink">
								...
								<form action="/AmazonBot/servlets/ItemActionServlet">
									<div id="authorisation">
										<div class="input-item" id="left-side-info">
											...
											<input type="text" name="item-image" class="input-field" size="50" placeholder="Input link to image of item (if you know)"></br>
											<input type="text" name="item-group" class="input-field" size="50" placeholder="Input group of item (if you know)"></br>
											<input type="hidden" name="action" value="addItem">
											<input type="hidden" name="btn" value="createNew">
											...
											<input type="text" name="item-position" class="input-field" size="50" placeholder="Input position of item (if you know)"></br>
											<input type="text" name="item-page" class="input-field" size="50" placeholder="Input page of item (if you know)"></br>
											<input type="text" name="item-rank" class="input-field" size="50" placeholder="Input rank of item (if you know)"></br>
											</br>
										</div>
									<div  >
							...
							<div class="table-header">
								<form action="/AmazonBot/servlets/ItemActionServlet">
									<input type="text" name="link-item" id="input-link" placeholder="Paste link to fast creation of item" size="124" value="<%=session.getValue("link") %>">
									<input type="hidden" name="action" value="checkLink">
									<input type="submit" class="input-btn"" value="Check link">
							...
							<div id="form">
								<form action="/AmazonBot/servlets/ItemActionServlet">
									<div id="authorisation">
										<div class="input-item" id="left-side-info">
											<input type="text" required name="item-name" class="input-field" size="50" placeholder="Input name of item" value="<%=session.getValue("nameLink") %>"></br>
											<input type="text" required name="item-asin" class="input-field" size="50" placeholder="Input ASIN of item" value="<%=session.getValue("asinLink") %>"></br>
											<input type="text" required name="item-price" class="input-field" size="50" placeholder="Input price of item" value="<%=session.getValue("priceLink") %>"></br>
											<input type="text"  name="item-image" class="input-field" size="50" placeholder="Input link to image of item (if you know)" value="<%=session.getValue("imgLink") %>"></br>
											<input type="text"  name="item-group" class="input-field" size="50" placeholder="Input group of item (if you know)" value="<%=session.getValue("groupLink") %>"></br>
											<input type="hidden" name="action" value="addItem">
											<input type="hidden" name="btn" value="createNew">
											<input type="submit" class="btn-class"" value="Create item">
											</br>
								...
								<form action="/AmazonBot/servlets/ItemActionServlet" >
									<div id="authorisation">
										<div class="input-item" id="left-side-info">
											...
											<input type="text"  name="item-image" class="input-field" size="50" placeholder="Input link to image of item (if you know)" value="<%=item.imgSource%>"></br>
											<input type="text"  name="item-group" class="input-field" size="50" placeholder="Input group of item (if you know)" value="<%=item.group%>"></br>
											...
											<input type="text"  name="item-position" class="input-field" size="50" placeholder="Input position of item (if you know)" value="<%=item.position%>"></br>
											<input type="text"  name="item-page" class="input-field" size="50" placeholder="Input page of item (if you know)" value="<%=item.page%>"></br>
											<input type="text"  name="item-rank" class="input-field" size="50" placeholder="Input rank of item (if you know)" value="<%=rank%>"></br>
											</br>
										</div>
									<div  >
